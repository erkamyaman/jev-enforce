...
export async function findViolations({ text, kind, filePath, rules, ask, threshold }: CheckOptions): Promise<Violation[]> {
...
export function formatReason(violations: Violation[], kind: Kind): string {

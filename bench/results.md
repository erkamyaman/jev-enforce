...
- Latency per check: p50 346ms, p95 432ms
- Input tokens: 63761, about $0.00268 for the whole run

## Mistakes at threshold 0.8

- r16, rule 0: p=0.97, expected clean
- c08, rule 8: p=0.85, expected clean
- c20, rule 8: p=0.64, expected broken
- c29, rule 17: p=0.63, expected broken
- c31, rule 18: p=0.07, expected broken
